 ...
 * - Hook registration time (SC-003: <10ms)
 * - Hook cleanup validation (SC-006: no memory leaks)
 * - Callback latency (SC-005: p95 <500ms)
 */
 ...
 *
 * Target: No significant memory growth after 1000 cycles (SC-006)
 ...
 *
 * Target: 95% of callbacks within 500ms (SC-005)
